...
proc create_root_design { parentCell } {
  ...
  set SEM_UART [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 SEM_UART ]

  # Create ports
  set SEM_injection_0 [ create_bd_port -dir O SEM_injection_0 ]
  ...
  connect_bd_intf_net -intf_net tmr_sem_0_UART [get_bd_intf_ports SEM_UART] [get_bd_intf_pins tmr_sem_0/UART]

  # Create port connections
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_ports axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins tmr_sem_0/S_AXI_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports axi_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins tmr_sem_0/S_AXI_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net tmr_sem_0_SEM_injection [get_bd_ports SEM_injection_0] [get_bd_pins tmr_sem_0/SEM_injection]
